...
### Task-system tooling
- `make_taskdir`, `instantiate_taskdir_template`, `taskdir_template/` — create tasks; 5 weekly templates auto-spawn via anacron (see below)
...
- We use anacron to spawn some taskdir templates weekly, which is the variant of cron that doesn't require the system to always be running to work.
- See the anacrontab symlink in this dir.
